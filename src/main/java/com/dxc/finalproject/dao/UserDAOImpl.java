...
public class UserDAOImpl implements UserDAO {
	...
	public List<User> findAllUser() {
		...
		String hql = "FROM User as u WHERE u.userRole = :userRole";
		list = sessionFactory.getCurrentSession().createQuery(hql, User.class)
				.setParameter("userRole", Integer.valueOf(2)).getResultList();
		return list;
	}
